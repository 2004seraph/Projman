...
class Student < ApplicationRecord
  ...
  @@text_validation_regex = /(?i)^(?:(?![Ã—ÃžÃŸÃ·Ã¾Ã¸])[-'0-9a-zÃ€-Ã¿])+$/
  ...
  validates :username,        presense: true, length: { in: 5..16 },  format: { with: @@text_validation_regex }
  ...
  # def bootstrap_student(CSVString)
