...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_boolean, class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :vertical_collection, item_wrapper_class: "form-check", item_label_class: "form-check-label",
    ...
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "label", class: "col-form-label pt-0 d-block" do |ba|
      ba.use :label_text
    end
  ...
  config.wrappers :vertical_collection_inline, item_wrapper_class: "form-check form-check-inline",
                                               item_label_class: "form-check-label", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "label", class: "col-form-label pt-0 d-block" do |ba|
      ba.use :label_text
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: "form-check", item_label_class: "form-check-label",
                                          tag: "div", class: "form-group row", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: "form-check form-check-inline",
                                                 item_label_class: "form-check-label", tag: "div", class: "form-group row", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: "col-sm-3 col-form-label pt-0"
    b.wrapper :grid_wrapper, tag: "div", class: "col-sm-9" do |ba|
  ...
  config.wrappers :inline_boolean, tag: "span", class: "form-check mb-2 mr-sm-2",
                                   error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: "form-check-input", error_class: "is-invalid"
  ...
  config.wrappers :custom_boolean, class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_boolean_switch, class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :custom_collection_inline, item_wrapper_class: "custom-control custom-control-inline",
                                             item_label_class: "custom-control-label", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: "label", class: "col-form-label pt-0 d-block" do |ba|
      ba.use :label_text
  ...
  # custom file input
  config.wrappers :custom_file, tag: "div", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  # custom multi select
  config.wrappers :custom_multi_select, tag: "div", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
    b.wrapper tag: "div", class: "d-flex flex-row justify-content-between align-items-center" do |ba|
  ...
  # custom range input
  config.wrappers :custom_range, tag: "div", class: "form-group", error_class: "form-group-invalid" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :readonly
    b.optional :step
  ...
  config.wrappers :floating_labels_select, tag: "div", class: "form-label-group",
    ...
    b.use :html5
    b.optional :readonly
    b.use :input, class: "custom-select", error_class: "is-invalid"
    b.use :label
    b.use :full_error, wrap_with: { tag: "div", class: "invalid-feedback" }
    b.use :hint, wrap_with: { tag: "small", class: "form-text text-muted" }
  end
