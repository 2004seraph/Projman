...
ActiveRecord::Schema[7.0].define(version: 20_240_417_140_249) do
  ...
  create_enum 'project_choice_allocation', %w[random single_preference_submission team_average_preference]
  create_enum 'project_status',
              %w[draft awaiting_project_preference awaiting_team_project_allocation live completed archived]
