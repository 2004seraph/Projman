# genList.py - generate a class list, in the format given by the student records database, making up dummy students.
# Based on code generated by chatGPT, refined to match CEIS output. Prompt used:
#   I want to create some dummy data, a csv with the following column headers: Surname, Forename, Middle Names, Title, Known As, Fee Status, Student Username, Ucard No, Email, Reg. Status, Programme, Period, Module Code, 1st Grade, 2nd Grade, 3rd Grade, 4th Grade, NFC_Flag, HEFCE_Flag, Live Registration, Attending, Date of Birth, Personal Tutor, Supervisors
import csv
import random
